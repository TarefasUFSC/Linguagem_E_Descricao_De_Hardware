...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="NORMAL" CLOCK_ENABLE_OUTPUT_A="NORMAL" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="NO" INIT_FILE="ROM.hex" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 clocken0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 2048',
...
endmodule //MEMORIA_ROM_altsyncram
//VALID FILE
...
`endif
	...
	MEMORIA_ROM_altsyncram	MEMORIA_ROM_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.clocken0 (clken),
				.q_a (sub_wire0));
